...
function FaqSec() {
  return (
      <div className='w-[1440px] h-[1016px] bg-[#FAFAFF] flex flex-col justify-between items-center'>
          <div className='absolute top-[100px] w-[528px] h-[102px] flex flex-col gap-[12px] items-center'>
          ...
          <div className='absolute top-[301px] w-[751px] flex flex-col gap-[16px]'>
              <div className='flex flex-col rounded-[20px] bg-[#14131D05] p-[24px] border-[1px] border-[#14131D0A] backdrop-blur-[40px] gap-[8px]'>
              ...
              <div className='flex flex-col rounded-[20px] bg-[#14131D05] p-[24px] border-[1px] border-[#14131D0A] backdrop-blur-[40px] gap-[16px]'>
                  <div className='flex justify-between items-center'>
              ...
              <div className='flex flex-col rounded-[20px] bg-[#14131D05] p-[24px] border-[1px] border-[#14131D0A] backdrop-blur-[40px] gap-[16px]'>
                  <div className='flex justify-between items-center'>
                      <h1 style={{ fontFamily: 'SatoshiVariable', fontWeight: 640 }} className='w-[667px] text-[22px] leading-[106%] text-[#14131D] opacity-[74%]'>This is a very long frequently asked question about our services with more than one line?</h1>
                      <GoChevronDown className='w-[20px] h-[20px] opacity-[74%]' />
              ...
              <div className='flex flex-col rounded-[20px] bg-[#14131D05] p-[24px] border-[1px] border-[#14131D0A] backdrop-blur-[40px] gap-[16px]'>
                  <div className='flex justify-between items-center'>
                      <h1 style={{ fontFamily: 'SatoshiVariable', fontWeight: 640 }} className='w-[667px] text-[22px] leading-[106%] text-[#14131D] opacity-[74%]'>This is a frequently asked question?</h1>
                      <GoChevronDown className='w-[20px] h-[20px] opacity-[74%]' />
              ...
              <div className='flex flex-col rounded-[20px] bg-[#14131D05] p-[24px] border-[1px] border-[#14131D0A] backdrop-blur-[40px] gap-[16px]'>
                  <div className='flex justify-between items-center'> 
                      <h1 style={{ fontFamily: 'SatoshiVariable', fontWeight: 640 }} className='w-[667px] text-[22px] leading-[106%] text-[#14131D] opacity-[74%]'>This is a question?</h1>
                      <GoChevronDown className='w-[20px] h-[20px] opacity-[74%]' />
