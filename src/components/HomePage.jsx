    ...
    return (
        <div className="relative lg:min-h-[646px] min-h-screen w-screen bg-gradient-to-b from-[#0A0914] to-[#1B133A] overflow-hidden">
            ...
            <nav className='flex justify-between items-center border-white/10 pt-[12px] pr-[16px] pb-[12px] pl-[16px] lg:pt-[16px] lg:pr-[32px] lg:pb-[16px] lg:pl-[32px]'>
                <img data-aos="slide-right" src={logo} alt="logo" className='w-[90.165px] h-[14px] lg:w-[128.8px] lg:h-[20px]' />
                <div data-aos="slide-right" className='hidden lg:flex lg:gap-[48px] justify-center items-center'>
                ...
                <div data-aos="slide-right" className='flex lg:gap-[16px] gap-[12px] items-center'>
                    ...
                    <div className='lg:block cursor-pointer hidden relative lg:rounded-[10px] pt-[8px] pr-[12px] pb-[8px] pl-[12px] transform transition-transform duration-300 ease-in-out hover:scale-105' style={{ backgroundColor: 'rgba(104, 82, 214, 1)' }}>
                    ...
                    <div className='lg:hidden block pt-[10px] pr-[12px] pb-[10px] pl-[12px] bg-[#FAFAFF05] border-[1px] border-[#FAFAFF1A] rounded-[10px]'>
                        <MdNightlight className='text-white -rotate-45 lg:hidden block' />
                    </div>
                </div>
            </nav>

            <img data-aos="slide-right" src={comet} className='absolute lg:top-0 lg:left-0 top-[165px] z-0' alt="comet1" />
            <img data-aos="slide-right" src={comet2} className='hidden lg:block absolute bottom-0 left-0 z-0' alt="comet2" />
            <img data-aos="slide-right" src={comet3} className='absolute lg:top-[200px] lg:left-[1150px] right-[0px] bottom-[-100px]' alt="comet3" />

            <div data-aos="slide-right" className="absolute inset-0 z-0 pointer-events-none">
                {[...Array(25)].map((_, i) => {
            ...
            <div data-aos="slide-right" className="relative z-10 flex flex-col lg:flex-row justify-between items-center gap-[40px] px-[24px] lg:px-[176px] py-[40px]">
                ...
                <div data-aos="slide-right" className="bg-white/5 backdrop-blur-[100px] rounded-[24px] border border-white/10 w-full max-w-[528px] min-h-[434px] p-[32px] text-white shadow-xl">
                    ...
                    <div className='mt-[12px] rounded-[12px] px-[16px] py-[12px] inline-block relative transform transition-transform duration-300 ease-in-out hover:scale-105' style={{ backgroundColor: 'rgba(104, 82, 214, 1)' }}>
                        <img data-aos="slide-right" src={highlight} className='absolute top-[1px] bg-cover' alt="highlight" />
                        <p data-aos="slide-right" className=' select-none cursor-pointer text-[#FCFCFE] text-[14px] leading-[140%] tracking-[2%]' style={{ fontFamily: 'SatoshiVariable', fontWeight: 600 }}>
                            Submit application
                        </p>
                    </div>
                </div>
            ...
            <div data-aos="slide-right" className="absolute bottom-0 left-0 w-full h-[100px] bg-gradient-to-b from-transparent to-[#0A0914] z-20" />
        </div>
    );
}
